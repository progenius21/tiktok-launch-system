      ...
      <main id="main-content">
        ...
        <section className="hero" style={{ paddingBottom: 0 }}>
          ...
          <div className="hero-body">
            <div>
              <h1 className="hero-headline">
                ...
                USERS VIA
                <br />
                <span className="accent-line"><span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic' }}>TikTok.</span></span>
                ZERO
                <br />
                AD SPEND.
              </h1>
          ...
          <div className="proof-bar" role="list" aria-label="Key results">
            ...
            <div className="proof-item" role="listitem">
              <span className="proof-num">
                2<span className="unit" aria-hidden="true">M+</span>
              </span>
        ...
        {/* DASHBOARD PREVIEW */}
        <section id="dashboard-preview" className="dash-preview-section" aria-labelledby="dash-preview-heading">
          <div className="section-tag" aria-hidden="true">Your Growth Command Centre</div>
          <h2 className="section-title" id="dash-preview-heading">
            YOUR GROWTH
            <br />
            COMMAND CENTRE
          </h2>
          <div className="fake-browser" role="img" aria-label="Dashboard preview screenshot">
            <div className="fake-browser-bar" aria-hidden="true">
              <div className="fake-browser-dot" />
              <div className="fake-browser-dot" />
              <div className="fake-browser-dot" />
              <div className="fake-browser-url">app.tiklaunch.io/dashboard</div>
            </div>
            <div className="fake-browser-inner" aria-hidden="true">
          ...
          <div className="dash-preview-cta-line">
            ...
            <button className="btn-primary" onClick={handleCheckout} disabled={loading} type="button" aria-busy={loading}>
