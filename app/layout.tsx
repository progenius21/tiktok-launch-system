...
function readPublicEnv(name: string) {
  ...
  if (!value || value === "null" || value.startsWith("REPLACE_WITH_")) {
    return "";
  }
  return value;
}
...
export const metadata: Metadata = {
  metadataBase: new URL("https://tiklaunch.io"),
...
export default function RootLayout({
  ...
  const metaPixelId = readPublicEnv("NEXT_PUBLIC_META_PIXEL_ID");
  const tiktokPixelId = readPublicEnv("NEXT_PUBLIC_TIKTOK_PIXEL_ID");
